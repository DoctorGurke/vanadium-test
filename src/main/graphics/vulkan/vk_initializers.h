...
namespace vkinit
{
        ...
        VkPipelineDynamicStateCreateFlags flags = 0)
    {
        ...
        pipelineDynamicStateCreateInfo.dynamicStateCount = static_cast<
            uint32_t>(pDynamicStates.size());
        pipelineDynamicStateCreateInfo.flags = flags;
        return pipelineDynamicStateCreateInfo;
    }
    ...
    // Ray tracing related
    inline VkAccelerationStructureGeometryKHR
    ...
    inline VkRayTracingPipelineCreateInfoKHR
